...
//        public async Task<ResponseDto<string>> DeleteCoupon(int id)
//        {
//            var coupon = await _context.Coupons.FindAsync(id);
//            if (coupon == null)
//            {
//                return new ResponseDto<string>(false, "Coupon not found", null);
//            }

//            _context.Coupons.Remove(coupon);
//            await _context.SaveChangesAsync();

//            return new ResponseDto<string>(true, "Coupon deleted successfully", null);
//        }
